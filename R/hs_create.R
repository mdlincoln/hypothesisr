...
# Check locally if the token is a 22-character string
is_valid_token <- function(token) {
  if(nchar(token) != 22)
    stop(token, " should be a 22-character string. See https://hypothes.is/profile/developer to generate your own token.")
}
